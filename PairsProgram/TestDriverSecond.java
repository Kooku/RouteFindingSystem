...
public class TestDriverSecond {
	public static void main(String[] args) throws Exception {

		/*
		 * CheapestRoute 5433634 has a total of 5 legs costing 3.81$ going 972
		 * with a total of 5 Steps
		 * 
		 * Min StepsRoute 2430287 has a total of 5 legs costing 3.81$ going 972
		 * with a total of 5 Steps
		 * 
		 * ShortestRoute 17689166 has a total of 7 legs costing 4.62$ going 383
		 * with a total of 7 Steps
		 */
		...
		sm.addLeg(new TruckLeg(l7, l12, 30, "M"));
		...
		sm.addLeg(new Flight(l15, l14, 20, "F"));
	...
	//	Route r1 = sm.findCheapestRoute(l1, l13, "M");
